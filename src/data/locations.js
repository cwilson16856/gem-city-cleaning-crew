...
export const CITIES = {
  ...
  'huber-heights': {
    ...
    commercial: {
      ...
      intro: [
        "With over 43,000 residents and a location 10 minutes from Wright-Patterson Air Force Base, Huber Heights has grown into a real industrial and commercial center, not just a residential suburb.",
      ...
      faqs: [
        { question: 'Do you clean industrial facilities in Huber Heights?', answer: 'Yes. With over 43,000 residents and a location 10 minutes from Wright-Patterson AFB, Huber Heights has real industrial and commercial space, and that\'s part of our regular service area there.' },
  ...
  'tipp-city': {
    ...
    residential: {
      ...
      intro: [
        ...
        "We clean homes throughout Tipp City's roughly 10,600-resident community, from historic homes near Main Street to newer neighborhoods around the city's 20-plus parks."
      ],
      ...
      faqs: [
        ...
        { question: 'What zip code do you serve in Tipp City?', answer: "45371, covering Tipp City's roughly 10,600 residents, from historic homes near Main Street to newer neighborhoods around the city's parks." },
