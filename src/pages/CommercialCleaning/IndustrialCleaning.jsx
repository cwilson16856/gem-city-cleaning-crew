...
const PAGE_URL = 'https://gemcitycleaningcrew.com/industrial-cleaning'
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify(generateLocalBusinessSchema(['Dayton', 'Kettering', 'Huber Heights', 'Riverside', 'Vandalia']))}
        </script>
        ...
        <script type="application/ld+json">
          {JSON.stringify(generateLocationWebPageSchema({
            id: `${PAGE_URL}#webpage`,
            url: PAGE_URL,
            name: 'Industrial Cleaning Services Dayton',
            ...
            breadcrumbs: [
              ...
              { name: 'Industrial Cleaning', url: PAGE_URL }
            ]
          }))}
        </script>
