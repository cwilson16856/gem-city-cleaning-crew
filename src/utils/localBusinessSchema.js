...
// Real coordinates for the business's live, claimed GBP listing (CID
// 7373519259471335388), confirmed via OpenSEO's GBP lookup. The previous
// value here (39.76337, -84.13520) was the Maps embed's own view-center
// point, not the actual pin location, and didn't match the real listing.
// NOTE: src/components/AreasWeServe.jsx's Google Maps embed URL has its
// own separate, opaque coordinate encoding (inside its `pb=` parameter)
// that still needs a manual update — that string is a checksum-bearing
// blob generated by Google's own Share/Embed UI and shouldn't be
